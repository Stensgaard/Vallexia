        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          >
            <div class="flex items-center mb-2">
              ...
              <span class="font-medium text-gray-900">{{
                $t("dashboard.quickActions.browseRecipes")
              }}</span>
            </div>
            <p class="text-sm text-gray-600">
              {{ $t("dashboard.quickActions.browseRecipesDesc") }}
            </p>
          </button>
          ...
          >
            <div class="flex items-center mb-2">
              ...
              <span class="font-medium text-gray-900">{{
                $t("dashboard.quickActions.planMeals")
              }}</span>
            </div>
            <p class="text-sm text-gray-600">
              {{ $t("dashboard.quickActions.planMealsDesc") }}
            </p>
          </button>
          ...
          >
            <div class="flex items-center mb-2">
              <svg
                class="h-6 w-6 text-yellow-600 mr-2"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <span class="font-medium text-gray-900">{{
                $t("dashboard.quickActions.createList")
              }}</span>
            </div>
            <p class="text-sm text-gray-600">
              {{ $t("dashboard.quickActions.createListDesc") }}
            </p>
          </button>
          ...
          >
            <div class="flex items-center mb-2">
              ...
              <span class="font-medium text-gray-900">{{
                $t("dashboard.quickActions.trackNutrition")
              }}</span>
            </div>
            <p class="text-sm text-gray-600">
              {{ $t("dashboard.quickActions.trackNutritionDesc") }}
            </p>
          </button>
        </div>
      </div>
        ...
        >
          ...
          <div class="mt-2 flex items-center justify-between">
            <span class="text-xs text-gray-500"
              >{{ recommendation.calories }} cal</span
            >
            <button
