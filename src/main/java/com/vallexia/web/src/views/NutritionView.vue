<template>
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-2xl font-bold text-gray-900">{{ $t('nutrition.tracking') }}</h1>
    ...
    >
      ...
      <div class="flex-1">
        ...
        <p class="text-sm text-gray-700 mb-3" v-html="$t('nutrition.familyUpgrade.description')">
        </p>
        <router-link
          to="/subscription"
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 text-center">
        <div class="text-2xl font-bold text-gray-900 mb-2">{{ formatNumber(1240, 0) }}</div>
        <div class="text-sm text-gray-600">{{ $t('nutrition.calories') }}</div>
        <div class="text-xs text-gray-500 mt-1">{{ $t('nutrition.goal') }} {{ formatNumber(2000, 0) }}</div>
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 text-center">
        <div class="text-2xl font-bold text-gray-900 mb-2">{{ formatNutritionalValue(85) }}</div>
        <div class="text-sm text-gray-600">{{ $t('nutrition.protein') }}</div>
        <div class="text-xs text-gray-500 mt-1">{{ $t('nutrition.goal') }} {{ formatNutritionalValue(120) }}</div>
        <div class="w-full bg-gray-200 rounded-full h-2 mt-2">
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 text-center">
        <div class="text-2xl font-bold text-gray-900 mb-2">{{ formatNutritionalValue(145) }}</div>
        <div class="text-sm text-gray-600">{{ $t('nutrition.carbs') }}</div>
        <div class="text-xs text-gray-500 mt-1">{{ $t('nutrition.goal') }} {{ formatNutritionalValue(200) }}</div>
        <div class="w-full bg-gray-200 rounded-full h-2 mt-2">
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 text-center">
        <div class="text-2xl font-bold text-gray-900 mb-2">{{ formatNutritionalValue(45) }}</div>
        <div class="text-sm text-gray-600">{{ $t('nutrition.fat') }}</div>
        <div class="text-xs text-gray-500 mt-1">{{ $t('nutrition.goal') }} {{ formatNutritionalValue(65) }}</div>
        <div class="w-full bg-gray-200 rounded-full h-2 mt-2">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ $t('nutrition.weeklyProgress') }}</h3>
      <div class="grid grid-cols-7 gap-4">
        ...
        >
          ...
          <div class="text-xs text-gray-500">{{ formatNumber(day.calories, 0) }} cal</div>
        </div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ $t('nutrition.todaysMeals') }}</h3>
        <div class="space-y-4">
          <div
          ...
          >
            ...
            <div class="text-right">
              <div class="font-medium text-gray-900">{{ formatNumber(meal.calories, 0) }} cal</div>
              <div class="text-xs text-gray-500">{{ formatNutritionalValue(meal.protein) }} protein</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ $t('nutrition.nutritionalGoals') }}</h3>
        <div class="space-y-4">
          <div class="flex items-center justify-between">
            <span class="text-sm text-gray-600">{{ $t('nutrition.dailyCalories') }}</span>
            <span class="text-sm font-medium text-gray-900">{{ formatNumber(2000, 0) }}</span>
          </div>
          <div class="flex items-center justify-between">
            <span class="text-sm text-gray-600">{{ $t('nutrition.protein') }}</span>
            <span class="text-sm font-medium text-gray-900">{{ formatNutritionalValue(120) }}</span>
          </div>
          <div class="flex items-center justify-between">
            <span class="text-sm text-gray-600">{{ $t('nutrition.carbs') }}</span>
            <span class="text-sm font-medium text-gray-900">{{ formatNutritionalValue(200) }}</span>
          </div>
          <div class="flex items-center justify-between">
            <span class="text-sm text-gray-600">{{ $t('nutrition.fat') }}</span>
            <span class="text-sm font-medium text-gray-900">{{ formatNutritionalValue(65) }}</span>
          </div>
          <div class="flex items-center justify-between">
            <span class="text-sm text-gray-600">{{ $t('nutrition.fiber') }}</span>
            <span class="text-sm font-medium text-gray-900">{{ formatNutritionalValue(25) }}</span>
          </div>
        </div>
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 text-center">
      ...
      <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ $t('nutrition.comingSoon') }}</h3>
