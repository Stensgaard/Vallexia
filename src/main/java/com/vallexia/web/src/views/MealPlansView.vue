    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      <div class="flex items-center justify-between">
        ...
        <h2 class="text-lg font-semibold text-gray-900">
          {{ $t("mealPlans.weekOf", { range: weekRange }) }}
        </h2>
        <button
          class="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-md"
          @click="nextWeek"
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      >
        ...
        <h3 class="text-lg font-semibold text-gray-900 mb-2">
          {{ $t("mealPlans.autoGenerate.title") }}
        </h3>
        <p class="text-gray-600 mb-4">
          {{ $t("mealPlans.autoGenerate.description") }}
        </p>
        <button
          class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md font-medium"
        >
      ...
      >
        ...
        <h3 class="text-lg font-semibold text-gray-900 mb-2">
          {{ $t("mealPlans.useTemplate.title") }}
        </h3>
        <p class="text-gray-600 mb-4">
          {{ $t("mealPlans.useTemplate.description") }}
        </p>
        <button
      ...
      >
        <svg
          class="mx-auto h-12 w-12 text-purple-400 mb-4"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
        ...
        <h3 class="text-lg font-semibold text-gray-900 mb-2">
          {{ $t("mealPlans.copyWeek.title") }}
        </h3>
        <p class="text-gray-600 mb-4">
          {{ $t("mealPlans.copyWeek.description") }}
        </p>
        <button
