  ...
  <div class="relative">
    ...
    <div class="relative">
      <button
        ...
        :class="{
          'border-blue-300 bg-blue-50': selectedValue !== null && selectedValue !== undefined && selectedValue !== '',
        }"
        @click.stop="toggleDropdown"
      >
        <span class="block truncate">
          <span v-if="!selectedValue || selectedValue === ''" class="text-gray-500">
            {{ placeholder }}
          </span>
      ...
      >
        ...
        >
          <div
            ...
            :class="{
              'bg-blue-50': selectedValue === option.value,
            }"
          ...
          >
            <div class="flex items-center">
              ...
              <span
                ...
                :class="{
                  'font-medium text-gray-900': selectedValue === option.value,
                  'font-normal text-gray-700': selectedValue !== option.value,
                }"
              >
                {{ option.label }}
              </span>
