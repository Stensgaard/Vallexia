 ...
 * Works with cached recipes from the database (1-hour cache TTL per Spoonacular Terms of Use).
 * 
...
public class RecipeScalingService {
     ...
     */
    public RecipeDto scaleRecipe(Long recipeId, Integer targetServings) {
        ...
        RecipeDto scaledRecipe = recipeMapper.toRecipeDto(recipe);
        ...
        if (scaledRecipe.getNutritionalInfo() != null) {
            NutritionalInfoDto scaledNutrition = scaleNutritionalInfo(
                    scaledRecipe.getNutritionalInfo(), 
                    currentServings, 
                    targetServings
            );
     ...
     * 
     * @param nutritionalInfoDto nutritional info DTO to scale
     * @param currentServings current number of servings
     * @param targetServings target number of servings
    ...
    public NutritionalInfoDto scaleNutritionalInfo(
        ...
        dto.setCalories(nutritionalInfoDto.getCalories());
        dto.setProtein(nutritionalInfoDto.getProtein());
        dto.setCarbs(nutritionalInfoDto.getCarbs());
        dto.setFats(nutritionalInfoDto.getFats());
        dto.setFiber(nutritionalInfoDto.getFiber());
        dto.setSodium(nutritionalInfoDto.getSodium());
        dto.setSugar(nutritionalInfoDto.getSugar());
        dto.setPerServing(nutritionalInfoDto.getPerServing());
