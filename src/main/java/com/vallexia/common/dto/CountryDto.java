...
public class CountryDto {
    ...
    @Schema(description = "Default date format pattern", example = "MM/dd/yyyy")
    String defaultDateFormat;

    @Schema(description = "Default timezone ID", example = "America/New_York")
    String defaultTimezone;

    @Schema(description = "Default first day of week", example = "SUNDAY")
    String firstDayOfWeek;

    @Schema(description = "Default measurement system", example = "IMPERIAL")
